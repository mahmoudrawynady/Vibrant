...
public class PublicFragment extends Fragment {
    ArrayList<Hospital> publicHospitalList;
    private ListView publicHospitalListView;
    ...
    public PublicFragment() {
        publicHospitalList = new ArrayList<>();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        publicHospitalListView = (ListView) view.findViewById(R.id.public_listview);
        progressBar= (ProgressBar) view.findViewById(R.id.public_progress);
        initializeLists();
        initializeFireBaseInstances();
        getHospitalsInfo();

        ( (AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.public_unit);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data : hospitalDataSnapshot.getChildren()) {
                    ...
                    publicHospitalList.add(hospital);
                }

                ListWordAdapter listWordAdapter = new ListWordAdapter(getActivity().getApplicationContext(),
                        publicHospitalList, R.color.homeColor);
                publicHospitalListView.setAdapter(listWordAdapter);
